...
namespace SpatialMap_SparseSpatialMap
{
    public class Dragger : MonoBehaviour
    {
        ...
        public void StartEdit(GameObject obj)
        {
            ...
            if (meshFilter == null)
            {
                var meshRenderer = selection.GetComponentInChildren<SkinnedMeshRenderer>();
                OutlinePrefab.GetComponent<MeshFilter>().mesh = meshRenderer.sharedMesh;
                OutlinePrefab.transform.parent = meshRenderer.transform;
            }
            else
            {
